...
#ifndef SOFA_RGBDTRACKING_FakeCam_H
#define SOFA_RGBDTRACKING_FakeCam_H
...
class FakeCam : public virtual sofa::core::objectmodel::BaseObject {
public:
    SOFA_CLASS(SOFA_TEMPLATE(FakeCam,DataTypes), sofa::core::objectmodel::BaseObject);
...
#if defined(SOFA_EXTERN_TEMPLATE) && !defined(FakeCam_CPP)
#ifndef SOFA_FLOAT
extern template class SOFA_RGBDTRACKING_API FakeCam<defaulttype::Vec3dTypes>;
#endif
#ifndef SOFA_DOUBLE
extern template class SOFA_RGBDTRACKING_API FakeCam<defaulttype::Vec3fTypes>;
#endif
#endif
